...
- The {description} in the URL MUST be a simple, URL-encoded string detailing what the image should show. DO NOT use commas, apostrophes, quotes, or special characters in the prompt. Use only alphanumeric characters and spaces (e.g., use "grandmas recipes" instead of "grandma's recipes!").
- Examples: 
  https://image.pollinations.ai/prompt/a%20bowl%20of%20spicy%20coconut%20chutney%20authentic%20indian%20cuisine?width=600&height=400&nologo=true
  https://image.pollinations.ai/prompt/portrait%20of%20a%20friendly%20fitness%20trainer%20in%20a%20modern%20gym?width=400&height=400&nologo=true
- CRITICAL LOCALITY RULE: If the brand description mentions a specific locale, city, or culture (e.g., "Bangalore", "Paris", "Nigerian"), you MUST append that locale to EVERY image prompt so the people, architecture, and food authentically reflect that region! (e.g. "portrait%20of%20a%20local%20fitness%20trainer%20in%20bangalore%20india").
